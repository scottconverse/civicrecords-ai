...
| Current release | v1.7.2 (May 23, 2026) - CivicCore v1.2.0 shared-ingestion release-asset alignment |
...
As of the v1.7.2 source tree, the system implements:
