...
| Current release | v1.5.0 (May 10, 2026) - CivicCore v1.0.1 recovery alignment for ENG-002 |
...
As of the v1.5.0 source tree, the system implements:
...
**Release state:** Current public tag is **v1.5.0** (May 10, 2026), aligned to CivicCore v1.0.1 after the ENG-002 recovery migration. The older `v1.4.10` tag remains historical pre-gate, provisional, and must not be promoted as an attested baseline. The `[Unreleased]` CHANGELOG block above `[1.5.0]` is the collection point for post-v1.5.0 work.
