...
| Current release | v1.7.0 (May 22, 2026) - CivicCore v1.2.0 shared-ingestion release-asset alignment |
...
As of the v1.7.0 source tree, the system implements:
