...
> Release recovery notice (2026-05-07). The public `v1.4.10` tag is provisional and do-not-promote. It remains available as historical source, but no current public label should be read as release readiness until the recovery gates in `docs/release-recovery-status.md` pass locally and in CI.
